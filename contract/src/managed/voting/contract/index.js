...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      submit: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`submit: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const rating_0 = args_1[1];
        const choice_0 = args_1[2];
        const feedback_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('submit',
                                     'argument 1 (as invoked from Typescript)',
                                     'voting.compact line 83 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(rating_0).concat(_descriptor_1.toValue(choice_0).concat(_descriptor_6.toValue(feedback_0))),
        ...
        const result_0 = this._submit_0(context,
                                        partialProofData,
                                        rating_0,
                                        choice_0,
                                        feedback_0);
  ...
  initialState(...args_0) {
    ...
    const numChoices_0 = args_0[1];
    const maxRating_0 = args_0[2];
    ...
    if (!(typeof(numChoices_0) === 'bigint' && numChoices_0 >= 0n && numChoices_0 <= 255n)) {
    ...
    if (!(typeof(maxRating_0) === 'bigint' && maxRating_0 >= 0n && maxRating_0 <= 255n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 2 (argument 3 as invoked from Typescript)',
                                 'voting.compact line 44 char 1',
                                 'Uint<0..256>',
    ...
    state_0.setOperation('submit', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(6n),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(numChoices_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(7n),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(maxRating_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  _submit_0(context, partialProofData, rating_0, choice_0, feedback_0) {
    __compactRuntime.assert(rating_0 >= 1n, 'Rating must be >= 1');
    __compactRuntime.assert(rating_0
                            <=
                                                ...
                                                path: [
                                                       { tag: 'value',
                                                         value: { value: _descriptor_1.toValue(2n),
                                                                  alignment: _descriptor_1.alignment() } },
                                                       { tag: 'value',
                                                         value: { value: _descriptor_1.toValue(r_0),
                                                                  alignment: _descriptor_1.alignment() } }] } },
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: true, n: 2 } }]);
    const tmp_3 = _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                            partialProofData,
                                                                            [
                                                                             { dup: { n: 0 } },
                                                                             { idx: { cached: false,
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(tmp_3),
                                                                                              alignment: _descriptor_5.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(feedback_0),
                                                ...
                                                path: [
                                                       { tag: 'value',
                                                         value: { value: _descriptor_1.toValue(8n),
                                                                  alignment: _descriptor_1.alignment() } }] } },
                                       { addi: { immediate: parseInt(__compactRuntime.valueToBigInt(
                                                              { value: _descriptor_7.toValue(tmp_5),
                                                                alignment: _descriptor_7.alignment() }
                                                                .value
                                                            )) } },
                                       { ins: { cached: true, n: 1 } }]);
